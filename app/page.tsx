  ...
  return (
    ...
    >
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-6 md:mb-8">
                ...
                <p className="text-accent text-base md:text-lg">
                  Backend Developer, MlOps Engineer & OSS Enthusiast
                </p>
              </div>
              ...
              <div className="mb-6 md:mb-8 text-muted-foreground">
                <p className="text-base md:text-lg leading-relaxed mb-4">
                  Building scalable systems and products on{" "}
                  <span className="text-accent font-semibold">Production</span>.
                </p>
                <p className="mb-4 md:mb-6 text-sm md:text-base">
                  I specialize in backend architecture, system designs and game
                  engines.
                </p>
      ...
      <section
        ref={addToRefs}
        id="work"
        className="min-h-screen flex items-center justify-center px-4 md:px-6 py-8 md:py-12"
      >
        <div className="max-w-6xl mx-auto text-left w-full">
          {/* Terminal prompt */}
          <div className="mb-6 md:mb-8">
          ...
          <div className="grid gap-6 md:gap-8 lg:grid-cols-2">
            {/* Card - Google Student Ambassador */}
            <div className="group relative overflow-hidden border border-border rounded-xl bg-gradient-to-br from-card to-card/50 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-accent/50">
              ...
              <div className="relative p-6 md:p-8">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-accent/20 rounded-lg flex items-center justify-center">
                      <span className="text-accent font-bold text-lg">GSA</span>
                    </div>
                    <div>
                      ...
                      <p className="text-accent text-sm font-mono">
                        Google • Aug 2025 - Present
                      </p>
                    </div>
                  </div>
                  <a
                    href="https://aiskillshouse.com/ambassador-program"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Representing Google on campus, organizing tech events,
                  workshops, and building a bridge between students and Google’s
                  developer ecosystem.
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={skill}
                      className="px-3 py-1 bg-accent/10 text-accent rounded-full text-xs font-mono border border-accent/20 hover:bg-accent/20 transition-colors"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="group relative overflow-hidden border border-border rounded-xl bg-gradient-to-br from-card to-card/50 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-accent/50">
              ...
              <div className="relative p-6 md:p-8">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-accent/20 rounded-lg flex items-center justify-center">
                      <span className="text-accent font-bold text-lg">HCI</span>
                    </div>
                    <div>
                      <h3 className="text-xl md:text-2xl font-bold mb-1 text-foreground">
                        HCI Intern
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Exploring interdisciplinary research in{" "}
                  <span className="text-foreground font-semibold">
                    Human-Computer Interaction
                  </span>
                  , contributing to multiple projects in{" "}
                  <span className="text-foreground font-semibold">
                    Machine Learning
                  </span>
                  ,
                  ...
                  . Working on designing intelligent systems that enhance user
            ...
            <div className="group relative overflow-hidden border border-border rounded-xl bg-gradient-to-br from-card to-card/50 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-emerald-500/50">
              ...
              <div className="relative p-6 md:p-8">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-accent/20 rounded-lg flex items-center justify-center">
                      <span className="text-accent font-bold text-lg">FSD</span>
                    </div>
                    <div>
                      <h3 className="text-xl md:text-2xl font-bold mb-1 text-foreground">
                      ...
                      <p className="text-emerald-400 text-sm font-mono">
                        Multiple Products • Dec 2023 - Present
                      </p>
                    </div>
                  </div>
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Built ecommerce platforms, real-time chat systems, and
                  upgraded infrastructure for multiple products. Specialized in
                  full-stack development and system optimization for growing
                  businesses.
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Node.js", "React", "MongoDB", "WebSocket", "Redis"].map(
                    (tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-emerald-500/10 text-emerald-400 rounded-full text-xs font-mono border border-emerald-500/20 hover:bg-emerald-500/20 transition-colors"
                      >
                        {tech}
                      </span>
                    )
            ...
            {/* <div className="group relative overflow-hidden border border-border rounded-xl bg-gradient-to-br from-card to-card/50 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-accent/50">
              ...
              <div className="relative p-6 md:p-8">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-accent/20 rounded-lg flex items-center justify-center">
                      <span className="text-accent font-bold text-lg">I2</span>
                    </div>
                    <div>
                      <h3 className="text-xl md:text-2xl font-bold mb-1 text-foreground">
                      ...
                      <p className="text-accent text-sm font-mono">
                        Company Name • May 2024 - Aug 2024
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Built predictive ML models and improved data pipelines,
                  leading to 15% higher accuracy in production.
                </p>
      ...
      <section
        ref={addToRefs}
        id="about"
        className="min-h-screen flex items-center justify-center px-4 md:px-6 py-12 md:py-16"
      >
        <div className="max-w-6xl mx-auto text-left w-full">
          {/* Terminal prompt */}
          <div className="mb-6 md:mb-8">
                ...
                <div>
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p className="text-base md:text-lg">
                      Hey, I'm Ayush — a backend and MLOps developer who loves
                      solving hard system-level problems.
                    </p>
                    <p>
                      Currently serving as{" "}
                      <span className="text-accent font-semibold">
                        Google Student Ambassador and Backend and ML Enginner
                      </span>{" "}
                      where I help others and build products.
                    </p>
                    {/* <p>
                    ...
                    <p>
                      I enjoy working where clean code meets product impact:
                      optimizing DB queries to millisecond-level, designing
                      distributed systems for scale, and deploying
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-muted-foreground">
                      Building <span className="text-accent">nInjaOS</span>
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p className="text-base md:text-lg">
                    ...
                    collaborate with talented people. Whether you have a startup
                    idea, need technical consultation, or want to discuss
              ...
              <div className="space-y-6">
                ...
                <div className="group relative overflow-hidden border border-border rounded-xl bg-gradient-to-br from-card to-card/50 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-accent/50">
                  ...
                  <div className="relative p-6">
                    ...
                    <a
                      href="mailto:dev.ninja.work@gmail.com"
          ...
          <div className="grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground mb-3 md:mb-4 max-w-md text-sm md:text-base">
                Backend & MLOps developer building scalable systems and products
                that matter. Always learning, always building.
              </p>
              <div className="flex gap-3 md:gap-4">
                ...
                <a href="mailto:dev.ninja.work@gmail.com" className="nav-item">
